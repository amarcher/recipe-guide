...
export function NewPlanButton({
  ...
  async function startWithMode(mode: Mode | null) {
    setBusy(true);
    setPicking(false);
    try {
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-sm text-stone-600">
              You can always shift mid-conversation. This just sets the tone.
            </p>
            <div className="mt-4 flex flex-col gap-2">
              {MODE_OPTIONS.map((m) => (
                <button
                  key={m.mode}
                  type="button"
                  onClick={() => void startWithMode(m.mode)}
            ...
            <div className="mt-3 flex items-center justify-between">
              <button
                type="button"
                onClick={() => void startWithMode(null)}
